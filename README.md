- [Communication Protocol Overview](#communication-protocol-overview)
  ...
  - [Python](#python)
    ...
    - [A Troubleshooting Note: Path Names](#a-troubleshooting-note-path-names)
- [Codebase](#codebase)
...
Troubleshooting mostly involves Muscle Mutt and serial communication. There are two Teensy microcontrollers on Muscle Mutt: one for sending spike communication, and one for receiving sensory feedback. This means that there's a handful of places 
