...
axs[0].set_title(r'$Joint~Angle~(\degree)$', fontsize = 32) 
...
axs[1].set_title(r'$Extensor~Activation~(nV)$', fontsize = 32)
...
axs[2].set_title(r'$FFT$', fontsize = 32)

axs[0].set_xlim(8000,10000)
axs[1].set_xlim(8000,10000)
axs[2].set_xlim(0.1,4)

axs[0].set_xticks([8000, 9000, 10000], labels=['8', '9', '10'], fontsize = 28)
axs[1].set_xticks([8000, 9000, 10000], labels=['8', '9', '10'], fontsize = 28)
...
axs[0].set_xlabel(r"$Time~(s)$", fontsize = 32)
axs[1].set_xlabel(r"$Time~(s)$", fontsize = 32)
axs[2].set_xlabel(r"$Frequency~(Hz)$", fontsize = 32)
