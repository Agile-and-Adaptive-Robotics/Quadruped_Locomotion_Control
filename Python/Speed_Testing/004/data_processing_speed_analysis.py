...
fast_time_path = Path(r"Python\Speed_Testing\004\Fast\comm_times.npy")
fast_angle_path = Path(r"Python\Speed_Testing\004\Fast\joint_ang.npy")
fast_length_path = Path(r"Python\Speed_Testing\004\Fast\muscle_len.npy")
fast_MN_Activations_path = Path(r"Python\Speed_Testing\004\Fast\nonspk_data.npy")
fast_SPK_Activations_path = Path(r"Python\Speed_Testing\004\Fast\spk_data.npy")
...
medium_time_path = Path(r"Python\Speed_Testing\004\Medium\comm_times.npy")
medium_angle_path = Path(r"Python\Speed_Testing\004\Medium\joint_ang.npy")
medium_length_path = Path(r"Python\Speed_Testing\004\Medium\muscle_len.npy")
medium_MN_Activations_path = Path(r"Python\Speed_Testing\004\Medium\nonspk_data.npy")
medium_SPK_Activations_path = Path(r"Python\Speed_Testing\004\Medium\spk_data.npy")
...
slow_time_path = Path(r"Python\Speed_Testing\004\Slow\comm_times.npy")
slow_angle_path = Path(r"Python\Speed_Testing\004\Slow\joint_ang.npy")
slow_length_path = Path(r"Python\Speed_Testing\004\Slow\muscle_len.npy")
slow_MN_Activations_path = Path(r"Python\Speed_Testing\004\Slow\nonspk_data.npy")
slow_SPK_Activations_path = Path(r"Python\Speed_Testing\004\Slow\spk_data.npy")
...
plt.savefig(r"Python\Speed_Testing\004\left.png")
# plt.show()
...
plt.savefig(r"Python\Speed_Testing\004\right.png")
plt.show()
...
fig.savefig(r"Python\Speed_Testing\004\fft.png")