...
fast_time_path = Path(r"Python\Speed_Testing\003\Fast\comm_times.npy")
fast_angle_path = Path(r"Python\Speed_Testing\003\Fast\joint_ang.npy")
fast_length_path = Path(r"Python\Speed_Testing\003\Fast\muscle_len.npy")
fast_MN_Activations_path = Path(r"Python\Speed_Testing\003\Fast\nonspk_data.npy")
fast_SPK_Activations_path = Path(r"Python\Speed_Testing\003\Fast\spk_data.npy")
...
medium_time_path = Path(r"Python\Speed_Testing\003\Medium\comm_times.npy")
medium_angle_path = Path(r"Python\Speed_Testing\003\Medium\joint_ang.npy")
medium_length_path = Path(r"Python\Speed_Testing\003\Medium\muscle_len.npy")
medium_MN_Activations_path = Path(r"Python\Speed_Testing\003\Medium\nonspk_data.npy")
medium_SPK_Activations_path = Path(r"Python\Speed_Testing\003\Medium\spk_data.npy")
...
slow_time_path = Path(r"Python\Speed_Testing\003\Slow\comm_times.npy")
slow_angle_path = Path(r"Python\Speed_Testing\003\Slow\joint_ang.npy")
slow_length_path = Path(r"Python\Speed_Testing\003\Slow\muscle_len.npy")
slow_MN_Activations_path = Path(r"Python\Speed_Testing\003\Slow\nonspk_data.npy")
slow_SPK_Activations_path = Path(r"Python\Speed_Testing\003\Slow\spk_data.npy")
...
# plt.savefig("E:\Diagonal Fast/all_rear_Doggo.png")
# plt.show()
...
# plt.savefig("E:\Diagonal Fast/all_fore_Doggo.png")
plt.show()

print("Done")

# ---- Extract signals ----
fast_signal   = fast_MN_Activations[:, L_knee_joint_ext_muscle_index]
medium_signal = medium_MN_Activations[:, L_knee_joint_ext_muscle_index]
slow_signal   = slow_MN_Activations[:, L_knee_joint_ext_muscle_index]
