...
fast_time_path = Path(r"Python\Speed_Testing\006\Fast\comm_times.npy")
fast_angle_path = Path(r"Python\Speed_Testing\006\Fast\joint_ang.npy")
fast_length_path = Path(r"Python\Speed_Testing\006\Fast\muscle_len.npy")
fast_MN_Activations_path = Path(r"Python\Speed_Testing\006\Fast\nonspk_data.npy")
fast_SPK_Activations_path = Path(r"Python\Speed_Testing\006\Fast\spk_data.npy")
...
medium_time_path = Path(r"Python\Speed_Testing\006\Medium\comm_times.npy")
medium_angle_path = Path(r"Python\Speed_Testing\006\Medium\joint_ang.npy")
medium_length_path = Path(r"Python\Speed_Testing\006\Medium\muscle_len.npy")
medium_MN_Activations_path = Path(r"Python\Speed_Testing\006\Medium\nonspk_data.npy")
medium_SPK_Activations_path = Path(r"Python\Speed_Testing\006\Medium\spk_data.npy")
...
slow_time_path = Path(r"Python\Speed_Testing\006\Slow\comm_times.npy")
slow_angle_path = Path(r"Python\Speed_Testing\006\Slow\joint_ang.npy")
slow_length_path = Path(r"Python\Speed_Testing\006\Slow\muscle_len.npy")
slow_MN_Activations_path = Path(r"Python\Speed_Testing\006\Slow\nonspk_data.npy")
slow_SPK_Activations_path = Path(r"Python\Speed_Testing\006\Slow\spk_data.npy")
...
plt.savefig(r"Python\Speed_Testing\006\left.png")
# plt.show()
...
plt.savefig(r"Python\Speed_Testing\006\right.png")
plt.show()

print("Done")

# ---- Extract signals ----
fast_signal   = fast_MN_Activations[2000:, L_hip_joint_ext_muscle_index]
medium_signal = medium_MN_Activations[2000:, L_hip_joint_ext_muscle_index]
slow_signal   = slow_MN_Activations[2000:, L_hip_joint_ext_muscle_index]
...
axs.plot(freq_fast, mag_fast, label='Fast', color = 'blue')
axs.plot(freq_medium, mag_medium, label='Medium', color = 'red')
axs.plot(freq_slow, mag_slow, label='Slow', color = 'k')

axs.set_xlabel(r"$Frequency~(Hz)$")
axs.set_ylabel(r"$Magnitude$")
# plt.title("FFT of L Hip Joint Extensor Activation")
axs.set_xlim(0.1, 4)  # limit to 0–20 Hz
axs.set_ylim(0, 0.1e6)
axs.set_yticks([], labels=[])

axs.legend()
plt.show()

fig.savefig(r"Python\Speed_Testing\006\fft.png")
