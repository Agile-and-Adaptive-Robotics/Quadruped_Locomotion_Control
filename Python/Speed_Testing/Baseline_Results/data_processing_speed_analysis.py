...
fast_time_path = Path("Python\Speed_Testing\Baseline_Results\Fast\comm_times.npy")
fast_angle_path = Path("Python\Speed_Testing\Baseline_Results\Fast\joint_ang.npy")
fast_length_path = Path("Python\Speed_Testing\Baseline_Results\Fast\muscle_len.npy")
fast_MN_Activations_path = Path(r"Python\Speed_Testing\Baseline_Results\Fast\nonspk_data.npy")
fast_SPK_Activations_path = Path("Python\Speed_Testing\Baseline_Results\Fast\spk_data.npy")
...
medium_time_path = Path("Python\Speed_Testing\Baseline_Results\Medium\comm_times.npy")
medium_angle_path = Path("Python\Speed_Testing\Baseline_Results\Medium\joint_ang.npy")
medium_length_path = Path("Python\Speed_Testing\Baseline_Results\Medium\muscle_len.npy")
medium_MN_Activations_path = Path(r"Python\Speed_Testing\Baseline_Results\Medium\nonspk_data.npy")
medium_SPK_Activations_path = Path("Python\Speed_Testing\Baseline_Results\Medium\spk_data.npy")
...
slow_time_path = Path("Python\Speed_Testing\Baseline_Results\Slow\comm_times.npy")
slow_angle_path = Path("Python\Speed_Testing\Baseline_Results\Slow\joint_ang.npy")
slow_length_path = Path("Python\Speed_Testing\Baseline_Results\Slow\muscle_len.npy")
slow_MN_Activations_path = Path(r"Python\Speed_Testing\Baseline_Results\Slow\nonspk_data.npy")
slow_SPK_Activations_path = Path("Python\Speed_Testing\Baseline_Results\Slow\spk_data.npy")
