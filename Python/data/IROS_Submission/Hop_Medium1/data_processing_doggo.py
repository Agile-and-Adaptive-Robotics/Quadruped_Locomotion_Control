...
time_path = Path("comm_times.npy")
angle_path = Path("joint_ang.npy")
length_path = Path("muscle_len.npy")
MN_Activations_path = Path(r"nonspk_data.npy")
SPK_Activations_path = Path("spk_data.npy")
...
plt.savefig("E:\Hop Medium1/all_rear_Doggo.png")
# plt.show()
...
plt.savefig("E:\Hop Medium1/all_fore_Doggo.png")
plt.show()
