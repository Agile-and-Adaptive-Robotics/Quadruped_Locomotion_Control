...
time_path = Path("Python\data\comm_times.npy")
angle_path = Path("Python\data\joint_ang.npy")
length_path = Path("Python\data\muscle_len.npy")
MN_Activations_path = Path(r"Python\data\nonspk_data.npy")
SPK_Activations_path = Path("Python\data\spk_data.npy")
...
plt.savefig("E:\Lateral Medium/all_rear_Doggo.png")
# plt.show()
...
plt.savefig("E:\Lateral Medium/all_fore_Doggo.png")
plt.show()
