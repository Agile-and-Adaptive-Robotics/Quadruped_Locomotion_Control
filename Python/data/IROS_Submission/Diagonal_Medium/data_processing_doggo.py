...
time_path = Path("Python\data\IROS_Submission\Diagonal_Medium\comm_times.npy")
angle_path = Path("Python\data\IROS_Submission\Diagonal_Medium\joint_ang.npy")
length_path = Path("Python\data\IROS_Submission\Diagonal_Medium\muscle_len.npy")
MN_Activations_path = Path(r"Python\data\IROS_Submission\Diagonal_Medium\nonspk_data.npy")
SPK_Activations_path = Path("Python\data\IROS_Submission\Diagonal_Medium\spk_data.npy")
...
plt.savefig(r"Python\data\IROS_Submission\Diagonal_Medium/all_rear_Doggo.svg", format = 'svg', bbox_inches= 'tight')
# plt.show()
...
plt.savefig(r"Python\data\IROS_Submission\Diagonal_Medium/all_fore_Doggo.svg", format = 'svg', bbox_inches= 'tight')
plt.show()
