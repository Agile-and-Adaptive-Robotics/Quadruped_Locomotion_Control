...
int main (void)
{
	...
	while(1)
	{
		...
		// printf("Error:  %d, Vel_Set_v:  %d, adc_input:  %d, adc_input_v:  %d, Control:  %d, adc_output: %d\n",  (int) Error, (int) Vel_Set_v, adc_input, (int) adc_input_v, (int) Control, adc_output );
		printf("%d %d %d %d %d %d\n ",  adc_input, (int) adc_input_v, (int) Vel_Set_v, (int) Error, (int) Control, adc_output);
