...
const int L_hip_joint       = 0;
const int L_knee_joint      = 1;
const int L_ankle_joint     = 2;
const int R_hip_joint       = 3;
const int R_knee_joint      = 4;
const int R_ankle_joint     = 5;
const int L_scapula_joint   = 6;
const int L_shoulder_joint  = 7;
const int L_wrist_joint     = 8;
const int R_scapula_joint   = 9;
const int R_shoulder_joint  = 10;
const int R_wrist_joint     = 11;


const int R_hip_joint_ext_muscle      = 12;
const int R_hip_joint_flx_muscle      = 13;
const int R_knee_joint_ext_muscle     = 14;
const int R_knee_joint_flx_muscle     = 15;
const int R_ankle_joint_ext_muscle    = 0;
const int R_ankle_joint_flx_muscle    = 1;

const int L_hip_joint_ext_muscle      = 2;
const int L_hip_joint_flx_muscle      = 3;
const int L_knee_joint_ext_muscle     = 4;
const int L_knee_joint_flx_muscle     = 5;
const int L_ankle_joint_ext_muscle    = 6;
const int L_ankle_joint_flx_muscle    = 7;

const int R_scapula_joint_ext_muscle  = 8;
const int R_scapula_joint_flx_muscle  = 9;
const int R_shoulder_joint_ext_muscle = 10;
const int R_shoulder_joint_flx_muscle = 11;
const int R_wrist_joint_ext_muscle    = 12;
const int R_wrist_joint_flx_muscle    = 13;

const int L_scapula_joint_ext_muscle  = 14;
const int L_scapula_joint_flx_muscle  = 15;
const int L_shoulder_joint_ext_muscle = 0;
const int L_shoulder_joint_flx_muscle = 1;
const int L_wrist_joint_ext_muscle    = 2;
const int L_wrist_joint_flx_muscle    = 3;
...
const uint8_t press_mux_channels[num_press_sensor] = {
...
void setup() {
    ...
    pinMode(pressure_pin, INPUT); // set the initial mode of the common pin.
}
...
void read_all_joints() {
  ...
  for (int i = 0; i < num_press_sensor; i++) {
    pressure_mux.channel(press_mux_channels[i]);
    analogRead(pressure_pin); // Dummy read! Allows the Teensy ADC pin capacitor to charge
    sensor_data[num_potentiometer + i] = analogRead(pressure_pin)/4; // read byte-sized data
  }
}
